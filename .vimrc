...
" Expand tabs in C, C++, H, Java files to spaces
au BufRead,BufNewFile *.{c,cpp,h,java} set expandtab
au BufRead,BufNewFile *.{c,cpp,h,java} set shiftwidth=2
au BufRead,BufNewFile *.{c,cpp,h,java} set tabstop=2
